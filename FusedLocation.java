...
public class FusedLocation implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener {
    ...
    public static final int CALLBACK_REQUEST_PERMISSION = 961;
    ...
    public FusedLocation(Activity c, Callback callback) {
        this.mActivity = c;
    ...
    public void startLocationUpdates() {
        ...
        if (ActivityCompat.checkSelfPermission(mActivity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mActivity, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(mActivity, permissions, CALLBACK_REQUEST_PERMISSION);
            return;
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (numTries >= maxTries) {
            ...
            chooseNetworkGps();
            //Toast.makeText(mActivity, "latitude: "+mCurrentLocation.getLatitude()+" Longitude: "+mCurrentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean isNetworkEnabled() {
        return ((LocationManager) mActivity.getSystemService(Context.LOCATION_SERVICE)).isProviderEnabled(LocationManager.NETWORK_PROVIDER);
    }

    public boolean isGPSEnabled() {
        return ((LocationManager) mActivity.getSystemService(Context.LOCATION_SERVICE)).isProviderEnabled(LocationManager.GPS_PROVIDER);
    }
